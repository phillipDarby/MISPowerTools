...
namespace MISPowerTools.Library.Internal.Components
{
    /// <summary>
    ...
    public class Battery
    {
        ...
        public string BatteryStatusDescription
        {
            get
            {
                ...
                if (_batteryStatusDescription != null)
                    status = _batteryStatusDescription;

                switch (BatteryStatus)
                {
                    case 1:
                        status = "The battery is discharging";
                        break;
                    case 2:
                        status = "The system has access to AC so no battery is being discharged. However, the battery is not necessarily charging.";
                        break ;
                    case 3:
                    ...
                    case 9:
                        ...
                        break;
                    case 10:
                        status = "No battery is installed";
                        break;
                    case 11:
